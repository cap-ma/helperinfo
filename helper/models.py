...
class HelpfulGuide(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Helpful Guide'
        verbose_name_plural = 'Helpful Guides'
...
class GuideSection(models.Model):
    """Model for guide sections/chapters"""
...
class FAQ(models.Model):
    ...
    category = models.CharField(
        max_length=30,
        choices=HelpfulGuide.GUIDE_CATEGORIES,
        default='general'
    )
    is_featured = models.BooleanField(default=False)
    order = models.PositiveIntegerField(default=0)
